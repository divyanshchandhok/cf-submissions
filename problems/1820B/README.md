...
**Problem ID:** 1820B | **Rating:** 1100 | **Tags:** `math`, `strings`, `two pointers`
**Language:** PyPy 3-64 | **Time:** 218 ms | **Memory:** 22100 KB | **Solved At:** 2025-05-21 19:28
**Link:** [Codeforces Problem Page](https://codeforces.com/problemset/problem/1820/B)
...
We call a rectangle the set of all cells $(i, j)$ in the table, such that $x_1 \le i \le x_2$ and $y_1 \le j \le y_2$ for some integers $0 \le x_1 \le x_2  \lt  n$ and $0 \le y_1 \le y_2  \lt  n$.
...
011110001**1****1****1**100**1****1****1**110011111001111100

In the fifth test case, there is a table:

101010010101101010010**1**01101010010101
