# Interview
**Problem ID:** 1807E | **Rating:** 1300 | **Tags:** `binary search`, `implementation`, `interactive`
**Language:** PyPy 3-64 | **Time:** 327 ms | **Memory:** 28100 KB | **Solved At:** 2025-05-28 04:36
**Link:** [Codeforces Problem Page](https://codeforces.com/problemset/problem/1807/E)
...
<sub>A picture of the first test case. Pile $2$ has the special stone. The piles have weights of $1,3,3,4,5$, respectively.</sub>
