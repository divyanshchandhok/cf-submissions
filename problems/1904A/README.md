# Forked!
**Problem ID:** 1904A | **Rating:** 900 | **Tags:** `brute force`, `implementation`
**Language:** PyPy 3-64 | **Time:** 187 ms | **Memory:** 4200 KB | **Solved At:** 2025-03-14 14:52
**Link:** [Codeforces Problem Page](https://codeforces.com/problemset/problem/1904/A)
...
<sub>Example of a knight placement that forks the queen and king in the first test case. The squares that the knight attacks are highlighted in red.</sub>

In the second test case, a knight placed on $(2, 2)$ would attack both the king and queen.

<sub>Example of a knight placement that does not fork the queen and king in the second test case. The knight attacks the king but not the queen.</sub>
