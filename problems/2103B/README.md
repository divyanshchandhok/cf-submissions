# Binary Typewriter
**Problem ID:** 2103B | **Rating:** 1100 | **Tags:** `greedy`, `math`
**Language:** PyPy 3-64 | **Time:** 233 ms | **Memory:** 6100 KB | **Solved At:** 2025-04-21 20:32
**Link:** [Codeforces Problem Page](https://codeforces.com/problemset/problem/2103/B)
...
In the sixth test case, we can reverse the substring $s_{5\ldots 17}$, resulting in the string `1101`**1110110010010**`00`. It can be proven that the minimum number of operations needed to type the binary string is $29$.
