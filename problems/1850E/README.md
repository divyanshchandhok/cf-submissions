...
**Problem ID:** 1850E | **Rating:** 1100 | **Tags:** `binary search`, `geometry`, `implementation`, `math`
**Language:** PyPy 3-64 | **Time:** 140 ms | **Memory:** 16500 KB | **Solved At:** 2025-03-14 20:11
**Link:** [Codeforces Problem Page](https://codeforces.com/problemset/problem/1850/E)
...
<sub>A picture of the first test case. Here $c = 50 = 5^2 + 4^2 + 3^2$, so $w=1$ is the answer.</sub>
