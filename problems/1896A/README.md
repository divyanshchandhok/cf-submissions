# Jagged Swaps
**Problem ID:** 1896A | **Rating:** 800 | **Tags:** `sortings`
**Language:** PyPy 3-64 | **Time:** 156 ms | **Memory:** 4600 KB | **Solved At:** 2025-03-07 01:42
**Link:** [Codeforces Problem Page](https://codeforces.com/problemset/problem/1896/A)
...
In the second test case, we can choose index $i=2$ as $1 \lt 3$ and $3 \gt 2$ to form $[1, 2, 3, 5, 4]$. Then, we can choose index $i=4$ as $3 \lt 5$ and $5 \gt 4$ to form $[1, 2, 3, 4, 5]$.
