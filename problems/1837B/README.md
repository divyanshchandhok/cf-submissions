# Comparison String
**Problem ID:** 1837B | **Rating:** 900 | **Tags:** `greedy`
**Language:** C++23 (GCC 14-64, msys2) | **Time:** 46 ms | **Memory:** 0 KB | **Solved At:** 2025-08-06 17:18
**Link:** [Codeforces Problem Page](https://codeforces.com/problemset/problem/1837/B)
...
- $s_i$ is `<` if and only if $a_i  \lt  a_{i+1}$;
- $s_i$ is `>` if and only if $a_i  \gt  a_{i+1}$.
