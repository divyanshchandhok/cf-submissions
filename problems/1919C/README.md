# Grouping Increases
**Problem ID:** 1919C | **Rating:** 1400 | **Tags:** `data structures`, `dp`, `greedy`
**Language:** C++23 (GCC 14-64, msys2) | **Time:** 92 ms | **Memory:** 1100 KB | **Solved At:** 2025-08-03 13:47
**Link:** [Codeforces Problem Page](https://codeforces.com/problemset/problem/1919/C)
...
2. For an array $b$ of size $m$, define the penalty $p(b)$ of an array $b$ as the number of indices $i$ between $1$ and $m - 1$ where $b_i  \lt  b_{i + 1}$.
