# Shoe Shuffling
**Problem ID:** 1691B | **Rating:** 1000 | **Tags:** `constructive algorithms`, `greedy`, `implementation`, `two pointers`
**Language:** C++23 (GCC 14-64, msys2) | **Time:** 62 ms | **Memory:** 100 KB | **Solved At:** 2025-06-17 10:43
**Link:** [Codeforces Problem Page](https://codeforces.com/problemset/problem/1691/B)
...
The second line of each test case contains $n$ integers $s_1, s_2,\ldots,s_n$ ($1\leq s_i\leq10^9$, and for all $1\le i \lt n$, $s_i\le s_{i+1}$) — the shoe sizes of the students.
