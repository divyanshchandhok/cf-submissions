# Cover in Water
**Problem ID:** 1900A | **Rating:** 800 | **Tags:** `constructive algorithms`, `greedy`, `implementation`, `strings`
**Language:** C++23 (GCC 14-64, msys2) | **Time:** 46 ms | **Memory:** 0 KB | **Solved At:** 2026-02-05 22:16
**Link:** [Codeforces Problem Page](https://codeforces.com/problemset/problem/1900/A)
...
<sub>Operations in the second test case. White cells are empty, grey ones are blocked, and blue ones are water.</sub>
