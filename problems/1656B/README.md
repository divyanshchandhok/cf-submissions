# Subtract Operation
**Problem ID:** 1656B | **Rating:** 1100 | **Tags:** `data structures`, `greedy`, `math`, `two pointers`
**Language:** PyPy 3-64 | **Time:** 202 ms | **Memory:** 25800 KB | **Solved At:** 2025-05-27 20:47
**Link:** [Codeforces Problem Page](https://codeforces.com/problemset/problem/1656/B)
...
Given an integer $k$ ($k \gt 0$), find if there is some sequence of $n-1$ operations such that, after applying the operations, the only remaining element of the list is equal to $k$.
